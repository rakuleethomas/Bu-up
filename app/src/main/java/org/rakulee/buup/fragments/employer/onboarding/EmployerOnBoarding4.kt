...
class EmployerOnBoarding4 : Fragment() {
    ...
    lateinit var binding : FragmentEmployerOnBoarding4Binding
    ...
    fun skip(){
        // skip to next page
        val direction : NavDirections = EmployerOnBoarding4Directions.actionEmployerOnBoarding4ToEmployerOnBoarding5()
    ...
    companion object {
         ...
         * @return A new instance of fragment EmployerOnBoarding4.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            EmployerOnBoarding4().apply {
